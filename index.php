...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://asoundidea.co.za/kustomer_notifications/processor.php");
...
curl_setopt($ch, CURLOPT_TIMEOUT_MS, 100);      //just some very short timeout
curl_exec($ch);
curl_close($ch);
